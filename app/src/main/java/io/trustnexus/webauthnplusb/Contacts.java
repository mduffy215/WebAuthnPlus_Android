...
import io.trustnexus.webauthnplusb.fundstransfer.SendFunds;
...
public class Contacts extends ListActivityBase {
    ...
    private static final int[] TO_CONTACTS = {R.id.display_name, R.id.mobile_phone_number, R.id.email_address};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        byte[] credentialIconByteArray = credentialCursor.getBlob(credentialCursor.getColumnIndexOrThrow(DataBaseManager.CREDENTIAL_ICON));
        ...
        String providerName = credentialCursor.getString(credentialCursor.getColumnIndexOrThrow(DataBaseManager.CREDENTIAL_PROVIDER_NAME));
        TextView providerNameView = findViewById(R.id.provider_name);
        providerNameView.setText(providerName);

        String providerUrl = credentialCursor.getString(credentialCursor.getColumnIndexOrThrow(DataBaseManager.DOMAIN_NAME));
        TextView providerUrlView = findViewById(R.id.provider_url);
        providerUrlView.setText(providerUrl);

        String displayName = credentialCursor.getString(credentialCursor.getColumnIndexOrThrow(DataBaseManager.DISPLAY_NAME));
    ...
    protected void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        if (!checkMaxIdleTimeExceeded()) {
            ...
            String contactDisplayName = cursor.getString(cursor.getColumnIndexOrThrow("displayName"));
            log("contactDisplayName: " + contactDisplayName);

            String contactPhoneNumber = cursor.getString(cursor.getColumnIndexOrThrow("phoneNumber"));
            log("contactPhoneNumber: " + contactPhoneNumber);

            String emailAddress = cursor.getString(cursor.getColumnIndexOrThrow("emailAddress"));
            ...
            if (contactPhoneNumber == null || emailAddress == null) {
                ...
                ((WebAuthnPlus) getApplication()).setRecipientDisplayName(contactDisplayName);
    ...
    public void displayContacts() {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                updateBarHandler.post(() -> progressDialog.setMessage("Reading contacts : " + counter++ + "/" + cursor.getCount()));
                ...
                if (hasPhoneNumber > 0) {
                    ...
                    if (phoneCursor != null && phoneCursor.getCount() > 0) {
                        ...
                        while (phoneCursor.moveToNext()) {
                            ...
                            int indexOfDisplayNumber = phoneCursor.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Phone.NUMBER);
                ...
                if (emailCursor != null && emailCursor.getCount() > 0) {
                    ...
                    while (emailCursor.moveToNext()) {
                        ...
                        int indexOfEmailAddress = emailCursor.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Email.DATA);
            ...
            updateBarHandler.postDelayed(() -> progressDialog.cancel(), 500);
        }
    }
