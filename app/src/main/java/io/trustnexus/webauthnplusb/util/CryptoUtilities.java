...
public class CryptoUtilities {
    ...
    public static String[] generateParams_CreateSecurityKey(String password, SharedPreferences sharedPreferences, Context context) {
        ...
        try {
             ...
             *
             * When the obfuscatedIdentifier is hashed with the secretKey it is used
            ...
            /*
             * Use the secretKey generated by the user password and the stored SALT to encrypt the userSecurityKeyHex.
             ...
             */
            String userSecurityKeyHexDecrypted = decrypt(toHex(secretKey.getEncoded()), userSecurityKeyHexEncrypted);
            log("\n\n\n\n########userSecurityKeyHexDencrypted: " + userSecurityKeyHexDecrypted + "\n" + userSecurityKeyHex);
    ...
    public static String[] generateParams_MobileApplicationSignOn(String passwordValue, SharedPreferences sharedPreferences, Context context) {
        ...
        try {
             ...
             * mobile device.  When the obfuscatedIdentifier is hashed with the secretKey it is used
             * as an obfuscated identifier to obtain the user's userSecurityKey (i.e., the
             * key that is used to encrypt/decrypt user data).
             *
            ...
            Mac mac = Mac.getInstance(MAC_ALGORITHM);
            mac.init(secretKey);
            assert obfuscatedIdentifier != null;
