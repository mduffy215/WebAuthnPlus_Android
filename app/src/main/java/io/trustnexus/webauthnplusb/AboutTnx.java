...
public class AboutTnx extends ActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox demoMode = findViewById(R.id.demo_mode);
        ...
        demoMode.setOnCheckedChangeListener((buttonView, isChecked) -> {
                    ...
                    try {
                        ...
                        boolean demoMode1 = sharedPreferences.getBoolean(getString(R.string.demo_mode_key), true);
                        log("########AboutTnx::demoMode::" + demoMode1);
                    } finally {
