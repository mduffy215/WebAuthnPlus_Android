...
package io.trustnexus.webauthnplusb.distributedledger;
...
import io.trustnexus.webauthnplusb.Contacts;
...
import io.trustnexus.webauthnplusb.ImageCursorAdapterCredentials;
import io.trustnexus.webauthnplusb.ListActivityBase;
...
public class Signature extends ListActivityBase implements View.OnClickListener {
        ...
        try {
            ...
            if (firebaseDataEncryptedHashedHex.equalsIgnoreCase(transferDataEncryptedHashedHexTest)) {
                ...
                if (requestType.equals(Constants.FIREBASE_MSG_TYPE_SIGN_DISTRIBUTED_LEDGER)) {
                    ...
                    signatureButton.setBackground(ContextCompat.getDrawable(this, R.drawable.button_gradient));
                    ...
                    if (requestType != null) {
                        ...
                        if (requestType.equals(Constants.FIREBASE_MSG_TYPE_SIGN_DISTRIBUTED_LEDGER)) {
                            ...
                            try {
                                ...
                                retrieveUnsignedDistributedLedgerUrl = cursor.getString(cursor.getColumnIndexOrThrow(DataBaseManager.RETRIEVE_UNSIGNED_DISTRIBUTED_LEDGER_URL));
                                log("retrieveUnsignedDistributedLedgerUrl: " + retrieveUnsignedDistributedLedgerUrl);

                                returnSignedDistributedLedgerUrl = cursor.getString(cursor.getColumnIndexOrThrow(DataBaseManager.RETURN_SIGNED_DISTRIBUTED_LEDGER_URL));
    ...
    private void clearDisplay() {
        ...
        signatureButton.setBackground(ContextCompat.getDrawable(this, R.drawable.button_gradient2));
    ...
    private static class ProcessRetrieveTransactionUuid extends AsyncTask<String, Void, String> {
         ...
         */
        private final WeakReference<Signature> activityReference;
        ...
        protected void onPostExecute(String transactionUuid) {
            ...
            if (signature.processRetrieveUnsignedDistributedLedger) {
                ...
                assert distributedLedgerHash != null;
    ...
    private static class ProcessReturnSignedDistributedLedger extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            signature.signatureButton.setBackground(ContextCompat.getDrawable(signature, R.drawable.button_gradient2));
            ...
            if (result.equals(Constants.SIGNATURE_SUCCESSFUL)) {
                ...
                String welcomeMessage = signature.getString(R.string.thank_you) + " " + screenName.trim();
                signature.messageZero.setText(welcomeMessage);
