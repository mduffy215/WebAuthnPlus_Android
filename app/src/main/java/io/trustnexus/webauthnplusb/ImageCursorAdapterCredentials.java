...
public class ImageCursorAdapterCredentials extends SimpleCursorAdapter {
    ...
    public View getView(int pos, View inView, ViewGroup parent) {
        ...
        if (view != null) {
            ...
            String providerName = this.cursor.getString(this.cursor.getColumnIndexOrThrow(DataBaseManager.CREDENTIAL_PROVIDER_NAME));
            TextView providerNameView = view.findViewById(R.id.provider_name);
            providerNameView.setText(providerName);

            String providerUrl = this.cursor.getString(this.cursor.getColumnIndexOrThrow(DataBaseManager.DOMAIN_NAME));
            TextView providerUrlView = view.findViewById(R.id.provider_url);
            providerUrlView.setText(providerUrl);

            String displayName = this.cursor.getString(this.cursor.getColumnIndexOrThrow(DataBaseManager.DISPLAY_NAME));
            TextView displayNameView = view.findViewById(R.id.display_name);
            displayNameView.setText(displayName);

            String credentialType = this.cursor.getString(this.cursor.getColumnIndexOrThrow(DataBaseManager.CREDENTIAL_TYPE));
            ...
            switch (credentialType) {
                ...
                default:
                    ...
                    byte[] credentialIconByteArray = this.cursor.getBlob(this.cursor.getColumnIndexOrThrow(DataBaseManager.CREDENTIAL_ICON));
