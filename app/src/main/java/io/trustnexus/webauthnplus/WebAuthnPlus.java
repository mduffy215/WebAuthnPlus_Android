...
public class WebAuthnPlus extends Application {
  ...
  private String recipientDsplayName;
...
// ------------------------------------------------------------------------------------------------------------------
  ...
  public String getRecipientDsplayName() {
    return recipientDsplayName;
  }

  public void setRecipientDsplayName(String recipientDsplayName) {
    this.recipientDsplayName = recipientDsplayName;
  }
